...
# tu =  6.5*5 + 8*3 + 2*7 + 3*8.5 + 2*7 + 3*8 + 3*9 + 4*8 + 4*8 + 4*7 + 4*6.5 + 4*8.5 + 4*7.5 + 4*9.5 + 4*8.5 + 4*9 + 4*8.5 + 4*9 + 3*6 + 2*8.5 + 3*9 + 3*7.5 + 3*10 + 3*5.5 + 4*7 + 1*9.5 + 1*7.5 + 1*10 + 1*8 + 1*8 + 3*8.5 + 3*10
# mau = 5 +3 + 2 +3 +2 + 3 + 3 + 4*11 + 2 + 3 + 3 +3 + 3 +3 + 4 + 5 + 3 + 3
# print(tu/mau)